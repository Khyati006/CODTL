...
def optimize_gene_sequence(aa_sequence, s, selected_host_organism):
    ...
    if selected_host_organism == 'Vigna angularis':
        codon_bias_dict=codon_bias_dict_vigna_angularis
    if selected_host_organism == 'Vigna unguiculata':
        codon_bias_dict=codon_bias_dict_vigna_unguiculata
    if selected_host_organism == 'Vigna umbellata':
        codon_bias_dict=codon_bias_dict_vigna_umbellata
