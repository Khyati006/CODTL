    ...
    if choice == "Home":
        ...
        if st.checkbox("By DNA sequence"):
            ...
            if seq_file is not None:
                ...
                host_organisms = ["Phaseolus vulgaris", "Lathyrus sativus", "Vigna mungo", "Vigna radiata","Cajanus cajan", "Glycine max", "Pisum sativum", "lens culinaris", "Cicer arientum","Helianthus annuus", "Vigna angularis", "Vigna unguiculata", "Vigna umbellata"]
        ...
        try:
            ...
            if details_1 == "By DNA sequence":
                ...
                if st.checkbox("Deoptimized Sequence"):
                    ...
                    host_organisms = ["Phaseolus vulgaris", "Lathyrus sativus", "Vigna mungo", "Vigna radiata","Cajanus cajan", "Glycine max", "Pisum sativum", "lens culinaris", "Cicer arientum","Vigna angularis", "Vigna unguiculata", "Vigna umbellata"]
                    selected_host_organism = st.selectbox("Select Host Organism", host_organisms)
