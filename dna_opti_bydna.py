...
def optimize_codons(dna_seq, selected_host_organism):
    ...
    if selected_host_organism == 'Cajanus cajan' or selected_host_organism=='Phaseolus vulgaris' or selected_host_organism=='Vigna radiata'or selected_host_organism == 'Glycine max' or selected_host_organism=='Vigna angularis' or selected_host_organism=='Vigna unguiculata' or selected_host_organism=='Vigna umbellata' :
    ...
    if selected_host_organism == 'Helianthus annuus':
        codon_bias=codon_bias_heli
